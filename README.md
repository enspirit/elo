...
- **Interval functions**: `start(interval)`, `end(interval)`, `union(i1, i2)`, `intersection(i1, i2)`, `Duration(interval)` for working with time intervals
...
- **String functions**: `length`, `upper`, `lower`, `trim`, `trimStart`, `trimEnd`, `replace`, `replaceAll`, `padStart`, `padEnd`, `substring`, `split`, `reverse`, `contains`, `indexOf`, `isEmpty`, `isBlank`, `startsWith`, `endsWith`, `concat`, `extract`
- **Literals**:
  - Numbers: `42`, `3.14`
  - Booleans: `true`, `false`
  - Strings: `'hello'`
