...
- **List functions**: `contains`, `find`, `sort`, `sortBy`, `count`, `sum`, `sum(list, initial)`, `avg`, `min`, `max`, `firstBy`, `lastBy`, `reverse`, `unique`, `flat`, `join(list, separator)`, `split(string, separator)`
- **Literals**:
  - Numbers: `42`, `3.14`
  - Booleans: `true`, `false`
  - Strings: `'hello'`
