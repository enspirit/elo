(function (_) {
  ...
  return (function () {
    if (!(kIsNull({}.budget) == true)) throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
  ...
  return (function () {
    if (!kEq({ budget: 1500 }.budget, 1500))
...
(function (_) {
  ...
  return (function () {
    if (!kEq({ name: "Alice", age: 30 }.name, "Alice"))
      throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
  ...
  return (function () {
    if (!kEq({ name: "Alice", age: 30 }.age, 30))
      throw new Error("Assertion failed");
    return true;
  })();
})(null);
