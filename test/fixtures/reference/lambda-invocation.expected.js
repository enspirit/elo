...
(function (_) {
  ...
  return (function () {
    if (!kEq((() => 42)(), 42)) throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
  ...
  return (function () {
    if (!kEq((() => 2 * 3)(), 6)) throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
  ...
  return (function () {
    if (!kEq(((x) => kMul(x, 2))(5), 10)) throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
    ...
    if (
      !kEq(
        (() => {
          const nested = (x) =>
            (() => {
              const inner = (y) => kMul(y, 2);
              return kAdd(inner(x), 1);
            })();
          return nested(5);
        })(),
        11,
