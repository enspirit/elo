(function (_) {
  ...
  function pData(v, p) {
    if (typeof v === "string") {
      try {
        return pOk(JSON.parse(v), p);
      } catch {
        return pFail(p, "invalid JSON: " + JSON.stringify(v));
      }
    }
    return pOk(v, p);
  }
  ...
  return (function () {
    if (!kEq(pUnwrap(pData('{"name": "Alice"}', "")), { name: "Alice" }))
...
(function (_) {
  ...
  return (function () {
    if (!kEq(pUnwrap(pData("[1, 2, 3]", "")), [1, 2, 3]))
      throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
  ...
  return (function () {
    if (!kEq(pUnwrap(pData('{"user": {"name": "Bob"}}', "")).user.name, "Bob"))
      throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
  ...
  return (function () {
    if (!kEq(pUnwrap(pData('{"active": true}', "")).active, true))
      throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
  ...
  return (function () {
    if (!kEq(pUnwrap(pData('{"count": 42}', "")).count, 42))
      throw new Error("Assertion failed");
    return true;
  })();
})(null);
...
(function (_) {
  ...
  return (function () {
    if (!kEq({ x: 10 }.x, 10)) throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
...
(function (_) {
  ...
  return (function () {
    if (!kIsNull(pUnwrap(pData(null, "")))) throw new Error("Assertion failed");
    return true;
  })();
})(null);
(function (_) {
