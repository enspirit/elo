...
(function (_) {
  ...
  return (function () {
    if (
      !kEq(
        [1, 2, 3].reduce((acc, x) => kAdd(acc, x), 0),
        6,
      )
    )
      throw new Error("Assertion failed");
